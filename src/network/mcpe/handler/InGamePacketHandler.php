...
class InGamePacketHandler extends PacketHandler
{
	...
	private function handleNormalTransaction(NormalTransactionData $data): bool
	{
		...
		foreach ($data->getActions() as $networkInventoryAction) {
			if (
				($networkInventoryAction->sourceType === NetworkInventoryAction::SOURCE_TODO && ($networkInventoryAction->windowId === NetworkInventoryAction::SOURCE_TYPE_CRAFTING_RESULT ||
